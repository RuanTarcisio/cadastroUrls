...
import ssp.ba.gov.br.cadastrolinks.dto.LinkUpdateDto;
import ssp.ba.gov.br.cadastrolinks.service.validation.templ.Problem;

public class LinkUpdateValidation implements ConstraintValidator<LinkUpdate, LinkUpdateDto> {

	public void initialize(LinkUpdateDto ann) {
	}

	@Override
	public boolean isValid(LinkUpdateDto objDto, ConstraintValidatorContext context) {
